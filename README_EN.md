...
**Release focus:** `v1.3.3` restores Sanshi United chart-list reselection so a second saved chart syncs the right-side input panel and recalculates automatically across web and app.
...
- [GitHub Release v1.3.3](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.3)
...
- read the current version release page: [GitHub Release v1.3.3](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.3)
