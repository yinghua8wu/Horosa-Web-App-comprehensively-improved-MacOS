...
**Stability update:** `v1.2.4` keeps the ARM Mac install safeguards from `v1.2.3` and adds a trusted fast path after the first successful launch, so daily startup can stay fast without giving up the safe fallback to a full runtime check.
...
- [GitHub Release v1.2.4](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.2.4)
...
- read the current version release page: [GitHub Release v1.2.4](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.2.4)
