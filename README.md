...
[中文完整版](README_ZH.md) | [English Guide](README_EN.md) | [Latest Release](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/latest) | [中文版本说明](docs/releases/v1.1.7-zh.md) | [English Release Notes](docs/releases/v1.1.7-en.md)
...
<table>
  ...
  <tr>
    <td width="50%">
      Maintainers should start from the bilingual guides and versioned release documents instead of guessing from asset names.
    </td>
    <td width="50%">
      维护者请从双语说明和版本化文档进入，不要只靠 release 资产名反推结构。
    </td>
  </tr>
</table>
...
<table>
  <tr>
    <td width="50%">
      ...
      <a href="docs/releases/v1.1.7-en.md">v1.1.7 release notes</a><br />
      <a href="docs/releases/v1.1.7-zh.md">v1.1.7 Chinese release notes</a><br />
    ...
    <td width="50%">
      ...
      <a href="docs/releases/v1.1.7-zh.md">v1.1.7 中文版本说明</a><br />
      <a href="docs/releases/v1.1.7-en.md">v1.1.7 English Release Notes</a><br />
...
<table>
  <tr>
    <td width="50%">
      ...
      Read the current version docs: <a href="docs/releases/v1.1.7-en.md">v1.1.7 English</a> / <a href="docs/releases/v1.1.7-zh.md">v1.1.7 Chinese</a><br />
    ...
    <td width="50%">
      ...
      阅读当前版本文档：<a href="docs/releases/v1.1.7-zh.md">v1.1.7 中文</a> / <a href="docs/releases/v1.1.7-en.md">v1.1.7 English</a><br />
