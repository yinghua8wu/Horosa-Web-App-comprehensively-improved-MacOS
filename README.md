...
[中文完整版](README_ZH.md) | [English Guide](README_EN.md) | [Latest Release](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/latest) | [v1.3.2 版本页面](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.2) | [All Releases](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases)
...
<p><strong>Current release train / 当前发布线：v1.3.2</strong></p>
<p><strong>Release focus / 本次重点：</strong><code>v1.3.2</code> completes Part of Fortune primary-direction coverage in AI export, keeping web, app, table output, and export snapshots on the same result path.</p>
...
<table>
  <tr>
    <td width="50%">
      ...
      <a href="https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.2">v1.3.2 release page</a><br />
    ...
    <td width="50%">
      ...
      <a href="https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.2">v1.3.2 版本页面</a><br />
...
<table>
  <tr>
    <td width="50%">
      ...
      Read the current version release page: <a href="https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.2">v1.3.2</a><br />
    ...
    <td width="50%">
      ...
      阅读当前版本页面：<a href="https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.2">v1.3.2</a><br />
