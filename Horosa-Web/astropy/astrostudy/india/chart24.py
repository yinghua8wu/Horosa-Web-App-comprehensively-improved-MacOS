...
START_INDEX = {}
START_INDEX[const.ARIES] = const.LIST_SIGNS.index(const.LEO)
START_INDEX[const.TAURUS] = const.LIST_SIGNS.index(const.CANCER)
START_INDEX[const.GEMINI] = const.LIST_SIGNS.index(const.LEO)
START_INDEX[const.CANCER] = const.LIST_SIGNS.index(const.CANCER)
START_INDEX[const.LEO] = const.LIST_SIGNS.index(const.LEO)
START_INDEX[const.VIRGO] = const.LIST_SIGNS.index(const.CANCER)
START_INDEX[const.LIBRA] = const.LIST_SIGNS.index(const.LEO)
START_INDEX[const.SCORPIO] = const.LIST_SIGNS.index(const.CANCER)
START_INDEX[const.SAGITTARIUS] = const.LIST_SIGNS.index(const.LEO)
START_INDEX[const.CAPRICORN] = const.LIST_SIGNS.index(const.CANCER)
