...
START_INDEX[const.TAURUS] = const.LIST_SIGNS.index(const.LIBRA)
START_INDEX[const.GEMINI] = const.LIST_SIGNS.index(const.ARIES)
START_INDEX[const.CANCER] = const.LIST_SIGNS.index(const.LIBRA)
START_INDEX[const.LEO] = const.LIST_SIGNS.index(const.ARIES)
START_INDEX[const.VIRGO] = const.LIST_SIGNS.index(const.LIBRA)
START_INDEX[const.LIBRA] = const.LIST_SIGNS.index(const.ARIES)
START_INDEX[const.SCORPIO] = const.LIST_SIGNS.index(const.LIBRA)
START_INDEX[const.SAGITTARIUS] = const.LIST_SIGNS.index(const.ARIES)
START_INDEX[const.CAPRICORN] = const.LIST_SIGNS.index(const.LIBRA)
START_INDEX[const.AQUARIUS] = const.LIST_SIGNS.index(const.ARIES)
START_INDEX[const.PISCES] = const.LIST_SIGNS.index(const.LIBRA)
