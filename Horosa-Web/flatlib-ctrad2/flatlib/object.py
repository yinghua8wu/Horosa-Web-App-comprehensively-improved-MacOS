...
class GenericObject:
    ...
    def __init__(self):
        ...
        self.signlon = 0.0
        self.azimuth = 0.0
        self.altitudeTrue = 0.0
        self.altitudeAppa = 0.0
    ...
    def eqCoords0(self, zerolat=False):
        ...
        return utils.eqCoords0(self.lon, lat)
...
class House(GenericObject):
    ...
    def __init__(self):
        ...
        self.size = 30.0
        self.hsys = const.HOUSES_DEFAULT
        self.planets = []
        self.exalt = None
        self.ruler = None
    ...
    def inHouse(self, lon):
        ...
        dist = 0
        if self.hsys == const.HOUSES_WHOLE_SIGN:
