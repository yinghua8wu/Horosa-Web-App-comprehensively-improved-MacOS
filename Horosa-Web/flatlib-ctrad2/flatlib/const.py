...
VULCANUS = 'Vulcanus'
POSEIDON = 'Poseidon'
LIST_URANIAN = [CUPIDO, HADES, ZEUS, KRONOS, APOLLON, ADMETOS, VULCANUS, POSEIDON]
...
HOUSES_CARTER_POLI_EQUATORIAL = 'Carter Poli-Equatorial'
HOUSES_SUNSHINE = 'Sunshine'
HOUSES_SUNSHINE_ALT = 'Sunshine Alternate'
HOUSES_KRUSINSKI = 'Krusinski-Pisa-Goelzer'
HOUSES_PULLEN_SD = 'Pullen SD'
HOUSES_PULLEN_SR = 'Pullen SR'
HOUSES_APC = 'APC Houses'
HOUSES_SAVARD_A = 'Savard-A'
