...
export const fetchCelestialEvent = (event_id) => postXuanShiCached('celestial/event', { event_id });
export const fetchDecadeOmens = (p) => postXuanShi('celestial/decade-omens', p);
