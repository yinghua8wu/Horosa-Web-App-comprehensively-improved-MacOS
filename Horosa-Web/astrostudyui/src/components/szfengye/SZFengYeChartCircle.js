...
class SZFengYeChartCircle extends Su28ChartCircle{
	constructor(option){
		super(option);	
	}
	...
	drawOuterChart(r, rStep){
		...
		for(let i=0; i<signsRA.length; i++){
			...
			let txts = SZConst.SZFengYeCircle[i].slice(0);
...
export default SZFengYeChartCircle;
