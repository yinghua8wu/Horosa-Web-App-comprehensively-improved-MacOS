...
class HouseSu15 extends HouseSu{
	constructor(option){
		super(option)
	}
	...
	drawTitle(){
		...
		this.titleSvg = drawTextH(this.svg, data, x, y, w, h, this.margin, Su28Helper.getSu28Color(15));	
		this.genTooltip();	
	}
	...
	drawStar(){
		...
		let orgx = this.x + this.width - this.fontSize - this.margin*2;
