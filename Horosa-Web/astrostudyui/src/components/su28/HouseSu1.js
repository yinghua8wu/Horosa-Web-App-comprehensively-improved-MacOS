...
import { drawPath, drawTextH,} from '../graph/GraphHelper';
import {randomStr,} from '../../utils/helper';

class HouseSu1 extends HouseSu{
	constructor(option){
		super(option);
	}
	...
	drawTitle(){
		...
		this.titleSvg = drawTextH(this.svg, data, x, y, w, h, this.margin, Su28Helper.getSu28Color(1));		
		this.genTooltip();	
	}
