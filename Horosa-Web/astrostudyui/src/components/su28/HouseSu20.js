...
class HouseSu20 extends HouseSu{
	constructor(option){
		super(option)
	}
	...
	drawHouse(){
		...
		this.titleSvg = drawPath(this.svg, points, this.color);
	}
	...
	drawTitle(){
		...
		this.titleSvg = drawTextH(this.svg, data, x, y, w, h, this.margin, Su28Helper.getSu28Color(20));		
		this.genTooltip();	
	}
	...
	drawStar(){
		...
		let orgx = this.x + this.margin;
		let y = this.y + this.fontSize*2 + this.fontSize/2 + this.margin* 2;
