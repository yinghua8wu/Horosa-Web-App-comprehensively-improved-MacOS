...
class HouseSu14 extends HouseSu{
	constructor(option){
		super(option)
	}
	...
	drawTitle(){
		...
		this.titleSvg = drawTextH(this.svg, data, x, y, w, h, this.margin, Su28Helper.getSu28Color(14));		
		this.genTooltip();	
	}
