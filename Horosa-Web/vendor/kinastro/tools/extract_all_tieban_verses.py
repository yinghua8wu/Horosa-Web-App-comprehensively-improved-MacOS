#!/usr/bin/env python3
"""
tools/extract_all_tieban_verses.py — 從《鐵板神數清刻足本.txt》提取 ALL 條文
...
def generate_json(verses, output_path):
    ...
    output_data = {
        "_meta": {
            ...
            "description": "鐵板神數條文資料庫 - 100% 來自原文（完整版，所有條文）",
            "version": "11.0",
            "total_verses": len(verses),
            "categories": list(categories.keys()),
            "parser": "tools/extract_all_tieban_verses.py",
...
def main():
    ...
    # 顯示示例條文
    print("\n📜 示例條文（前 20 條）:")
    sample_keys = list(verses.keys())[:20]
