 ...
 */
@Data
public class DaLiuRenJiChuSetting {
    ...
    /**
     * 贵人类型（0:自动切换。1:昼贵。2:夜贵）
     */
    private int guiRenType;
...
//*******************************************************************************************************************************
    ...
    public DaLiuRenJiChuSetting() {
        ...
        this.guiRenType = 0; // 贵人类型（默认→ 自动切换）
...
//===============================================================================================================================
     ...
     * 贵人类型
     *
     * @param guiRenType 贵人类型（0:自动切换。1:昼贵。2:夜贵）
     */
    public void setGuiRenType(int guiRenType) {
        this.guiRenType = (guiRenType == 0 || guiRenType == 1 || guiRenType == 2) ? guiRenType : 0;
    }
