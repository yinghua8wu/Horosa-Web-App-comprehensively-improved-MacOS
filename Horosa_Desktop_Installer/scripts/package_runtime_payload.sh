...
rsync -a "${REPO_ROOT}/Horosa-Web/start_horosa_local.sh" "${STAGE_ROOT}/Horosa-Web/"
rsync -a "${REPO_ROOT}/Horosa-Web/stop_horosa_local.sh" "${STAGE_ROOT}/Horosa-Web/"
rsync -a "${REPO_ROOT}/Horosa-Web/astropy" "${STAGE_ROOT}/Horosa-Web/"
rsync -a "${REPO_ROOT}/Horosa-Web/flatlib-ctrad2" "${STAGE_ROOT}/Horosa-Web/"
rsync -a "${REPO_ROOT}/Horosa-Web/astrostudyui/dist-file" "${STAGE_ROOT}/Horosa-Web/astrostudyui/"
rsync -a "${REPO_ROOT}/Horosa-Web/astrostudyui/scripts/warmHorosaRuntime.js" "${STAGE_ROOT}/Horosa-Web/astrostudyui/scripts/"
rsync -a "${REPO_ROOT}/runtime/mac/java" "${STAGE_ROOT}/runtime/mac/"
rsync -a "${REPO_ROOT}/runtime/mac/python" "${STAGE_ROOT}/runtime/mac/"
rsync -a "${REPO_ROOT}/runtime/mac/bundle" "${STAGE_ROOT}/runtime/mac/"
