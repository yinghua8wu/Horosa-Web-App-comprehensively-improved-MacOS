...
echo "HOROSA_DESKTOP_SKIP_REBUILD=1 ./scripts/verify_desktop_packaging.sh"
echo "./scripts/verify_public_distribution_readiness.sh"
echo "HOROSA_PUBLIC_DISTRIBUTION=1 ./scripts/publish_github_release.sh"
