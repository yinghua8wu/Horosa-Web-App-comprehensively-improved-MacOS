...
sections = [
    ...
    "- `v1.3.1` 补齐主限法福点输出，并让 Core-Alchabitius、星阙原方法与 AI 导出各自保持一致的结果口径。",
    "- `v1.3.1` adds Part of Fortune primary-direction output while keeping Core-Alchabitius, the Horosa legacy method, and AI export on consistent result paths.",
