...
**稳定性更新：** `v1.2.4` 在 `v1.2.3` 的 ARM Mac 安装修复基础上，继续加入“首次完整检查、后续可信快速启动”的策略，让日常启动更快，同时保留失败时自动回退到完整检查的稳定性兜底。
...
- 想看当前版本页面：看 [GitHub Release v1.2.4](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.2.4)
- 想进入主工程：看 `Horosa-Web/`
