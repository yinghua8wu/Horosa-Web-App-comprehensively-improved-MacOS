...
**本次重点：** `v1.3.3` 修复三式合一从星盘列表二次切换命盘时右侧输入栏不同步的问题，确保新命盘会自动带入并重新起盘。
...
- 想看当前版本页面：看 [GitHub Release v1.3.3](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.3.3)
- 想进入主工程：看 `Horosa-Web/`
