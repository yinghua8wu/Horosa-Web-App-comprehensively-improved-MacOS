...
**稳定性更新：** `v1.2.1` 重点修复 ARM Mac 在首次安装后排盘仍依赖本地 MongoDB 的问题，并把发布验收收紧到真实排盘执行链路。
...
- 想看当前版本页面：看 [GitHub Release v1.2.1](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.2.1)
- 想进入主工程：看 `Horosa-Web/`
