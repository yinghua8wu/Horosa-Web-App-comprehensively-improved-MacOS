...
公证离线 `.pkg`、app zip、runtime 包与 manifest 已统一对齐到 `2.5.2 / 2.5.2-runtime1`。完整改动见 [v2.5.2 Release](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v2.5.2)。
