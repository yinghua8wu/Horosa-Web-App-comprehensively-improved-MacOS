...
**稳定性更新：** `v1.2.2` 重点修复离线 pkg 安装后的共享 runtime 残缺场景：启动前先验证内置 Java，可疑时自动回退到用户 runtime，并允许从本地缓存 runtime 自恢复。
...
- 想看当前版本页面：看 [GitHub Release v1.2.2](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v1.2.2)
- 想进入主工程：看 `Horosa-Web/`
