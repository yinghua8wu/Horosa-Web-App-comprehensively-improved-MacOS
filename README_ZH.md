...
[入口页](README.md) | [英文说明](README_EN.md) | [v2.0.1 Beta](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v2.0.1)

**当前版本：** `v2.0.1 beta`

**本次重点：** `v2.0.1 beta` 延续 2.0 桌面交付线，重点修复奇门遁甲后端与 Horosa 手机版算法的一致性，尤其是起局与天盘干。
...
`2.0.1 beta` 是 2.0 桌面发布线的聚焦修复版。它继续保留签名离线安装路径，同时把奇门遁甲计算重新对齐 Horosa 手机版 API。
...
- `2.0.1 / 2.0.1-runtime1` 在 package、Tauri、release_config、README、manifest、app zip、离线 pkg 与 runtime 包中统一对齐
...
- 想看当前 beta 版本页面：看 [GitHub Release v2.0.1 Beta](https://github.com/Horace-Maxwell/Horosa-Web-App-comprehensively-improved-MacOS/releases/tag/v2.0.1)
- 想进入主工程：看 `Horosa-Web/`
